...
let one = RunningWorkout(distance: 12, time: 12)
let two = SwimmingWorkout(distance: 12, time: 12)
simpleWorkoutDescription(workout: one)
simpleWorkoutDescription(workout: two)
